import{d as S,S as v,k as T,o as R,aV as A,B,E as c,D as m,f as C,u as L,z as N,b as a,K as P,R as $}from"../index-DgQT6-E3.js";import{G as h}from"./GoBack-DFOEP6WC.js";import{T as D}from"./Toolbar-a6y3P9Xy.js";import{R as I}from"./ReusableDataTable-IpBj_tiT.js";import{i}from"./svg-D0Xk2Rxf.js";import{c as k,a as x}from"./Alerts-DFonG9jP.js";import H from"./CPR--2eIANhC.js";import{usePatientList as O}from"./patientListStore-Ca73A51Y.js";import{H as l}from"./service-CEWB11t0.js";import{d}from"./GlobalPropertyStore-D16PMXh4.js";import{closeVisit as U}from"./visits_service-CA0NRAS1.js";import{u as V}from"./useAETCStageRealtime-cwZixtjG.js";import{_ as E}from"./_plugin-vue_export-helper-DlAUqK2U.js";const F=S({__name:"ScreeningList",setup(J){const s=C([]),u=L(),b=["Visit Number","First Name","Last Name","Arrival Time","WaitingTime","Attended By","Action"],f={responsive:!0,ordering:!1,buttons:[]},o=O(),{AETCScreeningList:r}=v(o),e=()=>{s.value=r.value.map(t=>[t.visit_number,t.given_name,t.family_name,l.toStandardHisTimeFormat(t.arrival_time),l.waitingTime(t.latest_encounter_time),t.last_encounter_creator,_({identifier:t?.identifier,ID:t?.identifier,patient_id:t?.patient_id})])},{setupStageRealtimeUpdates:p,teardownStageRealtimeUpdates:g}=V({onUpdated:e}),_=t=>`

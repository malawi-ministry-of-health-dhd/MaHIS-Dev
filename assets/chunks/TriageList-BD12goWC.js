import{d as y,S as v,k as R,o as S,a2 as A,B,E as c,D as l,f as C,u as L,z as N,b as a,K as P,R as $}from"../index-DyGJhTIr.js";import{G as h}from"./GoBack-DFtowjhY.js";import{T as D}from"./Toolbar-CeqELa7O.js";import{R as I}from"./ReusableDataTable-C-918nJv.js";import{i as n}from"./svg-D4Mhbd11.js";import{c as k,a as x}from"./Alerts-CofpLC0X.js";import H from"./CPR-BorbLnB6.js";import{d}from"./GlobalPropertyStore-tH-mXmMj.js";import{closeVisit as O}from"./visits_service-DzH8LDv9.js";import{H as s}from"./service-B4ip0iQD.js";import{usePatientList as U}from"./patientListStore-BIwSFnUT.js";import{u as E}from"./useAETCStageRealtime-DlB-HfSJ.js";import{_ as F}from"./_plugin-vue_export-helper-DlAUqK2U.js";const J=y({__name:"TriageList",setup(V){const o=C([]),u=L(),b=["Visit Number","First Name","Last Name","Arrival Time","WaitingTime","Aggregate","Registered By","Action"],f={responsive:!0,ordering:!1,buttons:[]},r=U(),{AETCTriageList:m}=v(r),e=()=>{o.value=m.value.map(t=>[t.visit_number,t.given_name,t.family_name,s.toStandardHisTimeFormat(t.arrival_time),s.waitingTime(t.latest_encounter_time),s.waitingTime(t.arrival_time),t.last_encounter_creator,_({identifier:t?.identifier,ID:t?.identifier,patient_id:t?.patient_id})])},{setupStageRealtimeUpdates:p,teardownStageRealtimeUpdates:g}=E({onUpdated:e}),_=t=>`

import{d as R,L as h,w as T,o as A,W as L,q as B,v as p,t as u,r as C,u as N,j as $,A as i,B as x,K as H}from"../index-DisNC9Y0.js";import{G as O}from"./GoBack-BKBtI_VC.js";import{T as U}from"./Toolbar-D70NtmcQ.js";import{R as k}from"./ReusableDataTable-BpeRGiaw.js";import{i as o}from"./svg-D4Mhbd11.js";import{c as F,a as J}from"./Alerts-BJgbFjJv.js";import V from"./CPR-_tmsAiJA.js";import{usePatientList as W}from"./patientListStore-Cxf1rsLx.js";import{H as f}from"./service-D8WlmObq.js";import{d as b}from"./GlobalPropertyStore-CEcbnBaA.js";import{closeVisit as E}from"./visits_service-DY4Ey7Oo.js";import{u as G}from"./useAETCStageRealtime-DaZIFL_O.js";import{useDemographicsStore as M}from"./DemographicStore-Dg8ZeA5c.js";import{toastWarning as j}from"./toasts-BOk6sHyf.js";import{_ as q}from"./_plugin-vue_export-helper-DlAUqK2U.js";const K=R({__name:"ScreeningList",setup(w){const r=C([]),g=N(),_=["Visit Number","First Name","Last Name","Arrival Time","WaitingTime","Attended By","Action"],I={responsive:!0,ordering:!1,buttons:[]},y=M(),c=W(),{AETCScreeningList:d}=h(c),m=t=>{const e=t?.patient||{},s=t?.identifier??t?.ID??e?.identifier??e?.ID;return{patient_id:t?.patient_id??t?.patientID??t?.person_id??e?.patient_id??e?.patientID??e?.person_id,identifier:s,ID:s}},a=()=>{r.value=d.value.map(t=>[t.visit_number,t.given_name,t.family_name,f.toStandardHisTimeFormat(t.arrival_time),f.waitingTime(t.latest_encounter_time),t.last_encounter_creator,P(m(t))])},{setupStageRealtimeUpdates:D,teardownStageRealtimeUpdates:S}=G({onUpdated:a}),P=t=>`
